        ...
        <div class="wrapper">
            <div class="container">
                <div class="row">
                    <div class="span3">
                        <div class="sidebar">
                            <ul class="widget widget-menu unstyled">
                                ...
                                <li><a href="mentor_data.php"><i class="menu-icon icon-user"></i>Manage Mentors </a>
                                </li>
                    ...
                    <div class="span9">
                        <form class="form-horizontal row-fluid" action="mentor.php" method="post">
                                    ...
                                    if(isset($_POST['submit']))
                                        {$s=$_POST['title'];
                                            $sql="select * from LMS.mentor where (RollNo='$s' or Name like '%$s%') and RollNo<>'ADMIN'";
                                        }
                                    else
                                        $sql="select * from LMS.mentor where RollNo<>'ADMIN'";
