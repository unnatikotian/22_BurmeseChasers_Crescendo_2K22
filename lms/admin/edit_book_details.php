                    ...
                    <div class="span9">
                        <div class="module">
                            <div class="module-head">
                                <h3>Update Research Papers Details</h3>
                            </div>
                                ...
                                ?>
                                    ...
                                    <form class="form-horizontal row-fluid" action="edit_book_details.php?id=<?php echo $bookid ?>" method="post">
                                        <div class="control-group">
                                            <b>
                                            <label class="control-label" for="Title">Research Papers Title:</label></b>
                                            <div class="controls">
                                        ...
                                        <div class="control-group">
                                            <b>
                                            <label class="control-label" for="Availability">Availability of Mentors:</label></b>
                                            <div class="controls">
